        ...
        <div className='row'>
          <div className='col-md-6 offset-md-3'>
            <div className="input-group form-group">
              ...
              <input id="email" type="text" className="form-control form-control-reset" value={this.props.applicant.email} />
            </div>
            <div className="input-group form-group">
              <div className="input-group-prepend">
                <label htmlFor="name" className="input-group-text" id="basic-addon1">First Name</label>
              </div>
              <input id="name" type="text" className="form-control form-control-reset" value={this.props.applicant.first_name}/>
            </div>
            <div className="input-group form-group">
              <div className="input-group-prepend">
                <label htmlFor="lastName" className="input-group-text">Last Name</label>
              </div>
              <input id="lastName" type="text" className="form-control form-control-reset" value={this.props.applicant.last_name} />
            </div>
            <div className="input-group form-group">
              <div className="input-group-prepend">
                <label htmlFor="region" className="input-group-text">Region</label>
              </div>
              <input id="region" type="text" className="form-control form-control-reset" value={this.props.applicant.country} />
            </div>
            <div className="input-group form-group">
              <div className="input-group-prepend">
